...
class sixLetterWords: UIViewController, UITextViewDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let startWordsPath = Bundle.main.path(forResource: "six", ofType: "txt"){
            do{
